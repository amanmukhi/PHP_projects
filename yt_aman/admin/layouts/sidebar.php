     ...
     <div class="menu-items">
         <div class="menu-header hidden">
             <a href="index.php" class="flex items-center mx-8 mt-8">
                 <span class="avatar w-16 h-16">AM</span>
                 <div class="ltr:ml-4 rtl:mr-4 ltr:text-left rtl:text-right">
                     <h5>Aman Mukhi</h5>
                     <p class="mt-2">Web Dev</p>
                 </div>
             </a>
             <hr class="mx-8 my-4">
         </div>
         ...
         <a href="#" class="link" data-toggle="tooltip-menu" data-tippy-content="Blank Page">
             <span class="icon la la-file"></span>
             <span class="title">Blank Page</span>
         </a>
         <a href="#" target="_blank" class="link" data-toggle="tooltip-menu" data-tippy-content="Docs">
